...
class ResNet_cifar(ResNetBase):
    def __init__(
        ...
        # Use AdaptiveAvgPool2d to handle different input sizes (CIFAR-10: 32x32, STL-10: 96x96)
        self.avgpool = nn.AdaptiveAvgPool2d(1)  # Always outputs 1x1 regardless of input size
